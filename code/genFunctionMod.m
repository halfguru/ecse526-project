function out1 = genFunctionMod(net,filepath,varargin)
%GENFUNCTION Generate a MATLAB function for simulating a neural network.
% Modified by Maxence Boutet on 2016-11-18 to remove pruning of zero size inputs
% and outputs as it was problematic
% 
% Modified by Maxence Boutet on 2016-11-19 to comment the "path(path);" line
% that was slowing down the whole neat algorithm. Doesn't seem to cause problem.
%
